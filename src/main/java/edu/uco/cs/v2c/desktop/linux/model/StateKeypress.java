...
//     public StateKeypressMap() {
//         this.directiveToKeypressInteger = new HashMap<>();
//     }
    
//     public Integer directiveToInt(String directive) {
...
//         return this.directiveToKeypressInteger.get(directive);
//     }
    
//     public void updateKeypresses() {
//         for(StateKeypress keypress : values())
//             for(String d : keypress.directives)
//                 dire.put(d, keypress);
//     }
...
//     // keypressToDirective.put(KeyEvent.VK_0, "0");
//     // keypressToDirective.put(KeyEvent.VK_0, "zero");
//     // keyCodeToInt.put(fieldName, fieldValue);
//     // intToKeyCode.put(fieldValue, fieldName);
//     // map "zero" to "VK_0"
//     // use macro to map "VK_0" to KeyEvent.VK_0
// }

// public enum StateKeypressEnum {
...
// 	private StateKeypress(int event, String... directives) {
// 		this.keyEvent = event;
//         this.directives = directives;
// 	}

//     public static StateKeypress getKeypress(String directive) {
