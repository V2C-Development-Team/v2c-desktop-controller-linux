...
/**
 * Encapsulates the incoming {@link IncomingAction#HEARTBEAT} payload.
 * 
 * @author Caleb L. Power
 */
public class HeartbeatPayload extends IncomingPayload {
   ...
   */
  public HeartbeatPayload(JSONObject raw) throws PayloadHandlingException {
    super(raw, IncomingAction.HEARTBEAT);
